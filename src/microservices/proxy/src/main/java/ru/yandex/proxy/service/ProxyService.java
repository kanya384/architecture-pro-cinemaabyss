...
public class ProxyService {
    ...
    public <T> Mono<T> proxyGet(Map<String, String> headers, String endpoint, Class<T> responseType) {
    ...
    public <T, R> Mono<T> proxyPost(Map<String, String> headers, String endpoint, R body, Class<T> responseType) {
        var uuid = UUID.randomUUID();
